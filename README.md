...
For the full feature set see the [feature pages](https://docs.sisus.co/power-inspector/category/features/) of the online documentation.

## Acquiring Power Inspector
